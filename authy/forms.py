...
class SignupForm(forms.ModelForm):
    ...
    email = forms.CharField(widget=forms.TextInput(attrs={'class': 'input is-medium'}), max_length=100, required=True)
    ...
    def clean_email(self):
        ...
        if not email.endswith('@vitstudent.ac.in'):
            raise ValidationError('Email must end with @vitstudent.ac.in')
        return email
